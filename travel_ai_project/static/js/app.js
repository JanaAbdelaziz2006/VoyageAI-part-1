document.addEventListener("DOMContentLoaded", () => {
    ...
    const translations = {
        tr: {
            ...
            transport_not_available: "Bu ulaşım seçeneği bu güzergahta mevcut değildir.",
        ...
        en: {
            ...
            transport_not_available: "This transport option is not available for this route.",
        ...
        ar: {
            ...
            transport_not_available: "وسيلة النقل هذه غير متوفرة لهذا المسار.",
    ...
    function showErrorMessage(msg) {
        ...
        toast.innerHTML = `
            <div class="flex items-start gap-3">
                ...
                <div class="flex-1">
                    <h4 class="text-sm font-bold text-red-200 mb-1">${currentLang === "ar" ? "خطأ" : currentLang === "en" ? "Error" : "Hata"}</h4>
    ...
    function renderResults(data) {
        ...
        if (titleEl) titleEl.innerText = `${data.destination_city || ''} ${currentLang === "en" ? "Travel & Holiday Plan" : currentLang === "ar" ? "خطة السفر والعطلة" : "Gezi & Tatil Programı"}`;
        ...
        // Vehicle breakdown (for own car/EV)
        ...
        if (data.transportation?.vehicle_breakdown) {
                ...
                flightGrid.innerHTML = `
                    <div class="bg-slate-900 border border-slate-800 p-2.5 rounded-lg">
                        ...
                        <div class="text-slate-300 mt-1 text-[11px]">
                            ${currentLang === "en" ? "Round-trip distance" : currentLang === "ar" ? "المسافة ذهاباً وإياباً" : "Gidiş-dönüş mesafe"}: <strong>${vb.roundtrip_distance_km} km</strong><br>
                            ${vb.fuel_or_charge_type}
                        </div>
                    </div>
                    <div class="bg-slate-900 border border-slate-800 p-2.5 rounded-lg">
                        <div class="font-bold text-amber-400">💰 ${currentLang === "en" ? "Cost Breakdown" : currentLang === "ar" ? "تفصيل التكاليف" : "Maliyet Dökümü"}</div>
                        <div class="text-slate-300 mt-1 text-[11px]">
            ...
            const transitBadge = document.getElementById("resTransitBadge");
            if (transitBadge) transitBadge.innerText = currentLang === "en" ? "Direct Route" : currentLang === "ar" ? "خط مباشر" : "Direkt Hat";
            if (flightGrid) {
                flightGrid.innerHTML = `
                    <div class="bg-slate-900 border border-slate-800 p-2.5 rounded-lg">
